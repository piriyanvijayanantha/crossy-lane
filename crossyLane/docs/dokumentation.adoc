...
Schritt 4: HitBox erkennen. Eine kollision zwischen player und hinderniss führt zu gameOver. den screen müsste man auch erstellen.

Schritt 5: Score = höchste erreichte Lane
